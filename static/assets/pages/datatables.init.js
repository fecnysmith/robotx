!function (t) {
    ...
    a.prototype.createDataTableButtons = function () {
        ...
        t("#datatable").dataTable(), t("#datatable-keytable").DataTable({keys: !0}), t("#datatable-responsive").DataTable(), t("#datatable-scroller").DataTable({
        ...
        t("#datatable-fixed-header").DataTable({fixedHeader: !0});
