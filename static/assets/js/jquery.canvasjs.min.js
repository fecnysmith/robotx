...
(function () {
    ...
    function A(a, d, b, c, f) {
        ...
        (this.labelAngle -= 360);
        if (this.options.stripLines && 0 < this.options.stripLines.length)for (this.stripLines = [], d = 0; d < this.options.stripLines.length; d++)this.stripLines.push(new pa(this.chart, this.options.stripLines[d], a.theme, ++this.chart._eventManager.lastObjectId, this));
    ...
    var J = {}, v = !!document.createElement("canvas").getContext, ea = {
        Chart: {
            width: 500,
            height: 400,
            zoomEnabled: !1,
        ...
        theme1: {
            ...
            Subtitle: {
                fontFamily: v ? "Calibri, Optima, Candara, Verdana, Geneva, sans-serif" :
        ...
        null, Fa = function () {
        var a = /D{1,4}|M{1,4}|Y{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|f{1,3}|t{1,2}|T{1,2}|K|z{1,3}|"[^"]*"|'[^']*'/g, d = "Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "), b = "Sun Mon Tue Wed Thu Fri Sat".split(" "), c = "January February March April May June July August September October November December".split(" "), f = "Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "), g = /\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,
            h = /[^-+\dA-Z]/g;
        return function (l, k, n) {
            var m = n ? n.days : d, p = n ? n.months : c, e = n ? n.shortDays : b, r = n ? n.shortMonths : f;
            n = "";
            var q = !1;
            ...
            n = q ? "getUTC" : "get";
            var s = l[n + "Date"](), u = l[n + "Day"](), w = l[n + "Month"](), y = l[n + "FullYear"](), t = l[n + "Hours"](), v = l[n + "Minutes"](), aa = l[n + "Seconds"](), ca = l[n + "Milliseconds"](), x = q ? 0 : l.getTimezoneOffset();
        ...
        d = String(d);
        var h = 1, l = b = "", k = -1, n = [], m = [], p = 0, e = 0, r = 0, q = !1, s = 0, l = d.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
        d = null;
        for (var u = 0; l && u < l.length; u++)if (d = l[u], "." === d && 0 > k)k = u; else {
        ...
        a = (d[1] + "").split("");
        h && "0" === h[0] && h.shift();
        for (u = q = l = e = k = 0; 0 < n.length;)if (d = n.pop(), "#" === d || "0" === d)if (k++, k === p) {
            var w = h, h = [];
            if ("0" === d)for (d = p - e - (w ? w.length : 0); 0 < d;)w.unshift("0"),
                d--;
            for (; 0 < w.length;)b = w.pop() + b, u++, 0 === u % q && (l === r && 0 < w.length) && (b = g + b);
            c && (b = "-" + b)
        } else 0 < h.length ? (b = h.pop() + b, e++, u++) : "0" === d && (b = "0" + b, e++, u++), 0 === u % q && (l === r && 0 < h.length) && (b = g + b); else"E" !== d[0] && "e" !== d[0] || "0" !== d[d.length - 1] || !/[eE][+-]*[0]+/.test(d) ? "," === d ? (l++, q = u, u = 0, 0 < h.length && (b = g + b)) : b = 1 < d.length && ('"' === d[0] && '"' === d[d.length - 1] || "'" === d[0] && "'" === d[d.length - 1]) ? d.slice(1, d.length - 1) + b : d + b : (d = 0 > s ? d.replace("+", "").replace("-", "") : d.replace("-", ""), b += d.replace(/[0]+/, function (a) {
            return N(s,
                a.length)
        }));
        c = "";
        ...
        return {x: d, y: b}
    }, Na = !0, Ba = window.devicePixelRatio || 1, ua = 1, P = Na ? Ba / ua : 1, Oa = window && window.location && window.location.href && window.location.href.indexOf && -1 !== window.location.href.indexOf("canvasjs.com"), Va = {
    ...
    (function () {
        ...
        J.pro = {sCH: ea[J.fSDec([67, 104, 97, 114, 116])][J.fSDec([99, 114, 101, 100, 105, 116, 72, 114, 101, 102])]};
        J.fAWm = function (a) {
    ...
    M.prototype.updateOption = function (a) {
        var d = ea[this._defaultsKey], b = this.options.theme ? this.options.theme : this.chart && this.chart.options.theme ? this.chart.options.theme : "theme1", c = {}, f = this[a];
    ...
    z.prototype._initialize = function () {
        ...
        this.data = [];
        var a = 0;
        if (this.options.data)for (var d = 0; d < this.options.data.length; d++)if (a++, !this.options.data[d].type || 0 <= z._supportedChartTypes.indexOf(this.options.data[d].type)) {
    ...
    z.prototype.render = function (a) {
        ...
        for (a = 0; a < this.data.length; a++)if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) {
            if (!this.data[a].axisYType || "primary" === this.data[a].axisYType)if (this.options.axisY && 0 < this.options.axisY.length) {
                if (!this.axisY.length)for (var b = 0; b < this.options.axisY.length; b++)"normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY[b] = new A(this, this.options.axisY[b], "axisY", "left", b)) : "xySwapped" ===
            ...
            if ("secondary" === this.data[a].axisYType)if (this.options.axisY2 && 0 < this.options.axisY2.length) {
                if (!this.axisY2.length)for (b = 0; b < this.options.axisY2.length; b++)"normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[b] = new A(this, this.options.axisY2[b], "axisY", "right", b)) :
            ...
            if (!this.data[a].axisXType || "primary" === this.data[a].axisXType)if (this.options.axisX && 0 < this.options.axisX.length) {
                if (!this.axisX.length)for (b = 0; b < this.options.axisX.length; b++)"normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX[b] = new A(this, this.options.axisX[b],
            ...
            if ("secondary" === this.data[a].axisXType)if (this.options.axisX2 && 0 < this.options.axisX2.length) {
                if (!this.axisX2.length)for (b = 0; b < this.options.axisX2.length; b++)"normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX2[b] = new A(this, this.options.axisX2[b],
        ...
        if (this.options.subtitles)for (this.subtitles = [], a = 0; a < this.options.subtitles.length; a++)b = new xa(this, this.options.subtitles[a]), this.subtitles.push(b), b.dockInsidePlotArea ? d.push(b) : b.render();
        ...
        if ("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement)A.setLayoutAndRender(this.axisX, this.axisX2, this.axisY, this.axisY2, this.plotInfo.axisPlacement, this.layoutManager.getFreeSpace()); else if ("none" === this.plotInfo.axisPlacement)this.preparePlotArea(); else return;
        ...
        0 < c.length ? (k.disableToolTip = !0, k._animator.animate(200, k.animationDuration, function (a) {
            ...
            c = [];
            for (var a = 0; a < k.plotInfo.plotTypes.length; a++)for (var b = k.plotInfo.plotTypes[a], d = 0; d < b.plotUnits.length; d++)b.plotUnits[d].targetCanvas = null;
            f = null;
            k.disableToolTip = !1
        })) : (0 < k._indexLabels.length && k.renderIndexLabels(), k.dispatchEvent("dataAnimationIterationEnd", {chart: k}));
        this.attachPlotAreaEventHandlers();
        this.zoomEnabled || (this.panEnabled || !this._zoomButton || "none" === this._zoomButton.style.display) || $(this._zoomButton, this._resetButton);
    ...
    z.prototype.categoriseDataSeries = function () {
        for (var a =
            "", d = 0; d < this.data.length; d++)if (a = this.data[d], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= z._supportedChartTypes.indexOf(a.type)) {
            ...
            for (h = 0; h < b.plotUnits.length; h++)if (b.plotUnits[h].axisYType === a.axisYType && b.plotUnits[h].axisXType === a.axisXType &&
        ...
        for (d = 0; d < this.plotInfo.plotTypes.length; d++)for (b = this.plotInfo.plotTypes[d], h = a = 0; h < b.plotUnits.length; h++)b.plotUnits[h].previousDataSeriesCount = a, a += b.plotUnits[h].dataSeriesIndexes.length
    };
        ...
        function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, f, g = !1, h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                for (k = 0; k < l.dataPoints.length; k++) {
                    ...
                    if (c < e && !n)null !== f && (p = c); else {
                        if (!n && (n = !0, 0 < k)) {
                            k -= 2;
                            continue
                        }
                        if (c > r && !m)m = !0; else if (c > r && m)continue;
    ...
    z.prototype._processStackedPlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, f, g = !1, h = [], l = [], k = Infinity, n = 0; n < a.dataSeriesIndexes.length; n++) {
                var m = this.data[a.dataSeriesIndexes[n]], p = 0, e = !1, r = !1, q;
                ...
                for (p = 0; p < m.dataPoints.length; p++) {
                    ...
                    if (c < s && !e)null !== m.dataPoints[p].y && (q = c); else {
                        if (!e && (e = !0, 0 < p)) {
                            p -= 2;
                            continue
                        }
                        if (c > u && !r)r = !0; else if (c > u && r)continue;
    ...
    z.prototype._processStacked100PlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            ...
            a.axisY.logarithmic ? (d.max = x(d.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase, -0.05) : Math.max(d.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase, -0.05)), d.min = x(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : h && !l ? (d.max = x(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99), d.min = x(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : h && l ? (d.max = x(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99), d.min = x(d.viewPortMin) ? -99 : Math.min(d.viewPortMin,
                -99)) : !h && l && (d.max = x(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1), d.min = x(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99));
            d.viewPortMin = d.min;
            d.viewPortMax = d.max;
            a.dataPointYSums = k
        }
    ...
    z.prototype._processMultiYPlotUnit = function (a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))for (var d = a.axisY.dataInfo, b = a.axisX.dataInfo, c, f, g, h, l = !1, k = 0; k < a.dataSeriesIndexes.length; k++) {
            var n = this.data[a.dataSeriesIndexes[k]], m = 0, p = !1, e = !1, r, q, s;
    ...
    z.prototype.getDataPointAtXY = function (a,
        ...
        a = null;
        d = !1;
        for (b = 0; b < c.length; b++)if ("line" === c[b].dataSeries.type || "stepLine" === c[b].dataSeries.type || "area" === c[b].dataSeries.type || "stepArea" === c[b].dataSeries.type)if (f = S("markerSize", c[b].dataPoint, c[b].dataSeries) || 8, c[b].distance <= f / 2) {
            d = !0;
            break
        }
    ...
    z.prototype.getObjectAtXY = function (a, d, b) {
        var c = null;
        if (b = this.getDataPointAtXY(a, d, b || !1))c = b.dataSeries.dataPointIds[b.dataPointIndex]; else if (v)c = Ma(a, d, this._eventManager.ghostCtx); else for (b = 0; b < this.legend.items.length; b++) {
    ...
    z.prototype._touchEventHandler = function (a) {
        if (a.changedTouches && this.interactivityEnabled) {
            var d = [], b = a.changedTouches, c = b ? b[0] :
                a, f = null;
            switch (a.type) {
                case "touchstart":
                case "MSPointerDown":
            ...
            if (!(b && 1 < b.length)) {
                ...
                if (this._lastTouchData.scroll && this.zoomEnabled)this.isDrag && this.resetOverlayedCanvas(), this.isDrag = !1; else for (b = 0; b < d.length; b++)f = d[b], g = document.createEvent("MouseEvent"), g.initMouseEvent(f, !0, !0, window, 1, c.screenX, c.screenY, c.clientX, c.clientY, !1, !1, !1, !1, 0, null), c.target.dispatchEvent(g), a.preventManipulation &&
    ...
    z.prototype._plotAreaMouseUp = function (a, d) {
        if (("normal" === this.plotInfo.axisPlacement ||
            ...
            if (this.panEnabled || this.zoomEnabled) {
                if (this.panEnabled)for (f = g = 0; f < this._axes.length; f++)b = this._axes[f], b.logarithmic ? b.viewportMinimum < b.minimum ? (g = b.minimum / b.viewportMinimum, b.sessionVariables.newViewportMinimum = b.viewportMinimum *
                    g, b.sessionVariables.newViewportMaximum = b.viewportMaximum * g, h = !0) : b.viewportMaximum > b.maximum && (g = b.viewportMaximum / b.maximum, b.sessionVariables.newViewportMinimum = b.viewportMinimum / g, b.sessionVariables.newViewportMaximum = b.viewportMaximum / g, h = !0) : b.viewportMinimum < b.minimum ? (g = b.minimum - b.viewportMinimum, b.sessionVariables.newViewportMinimum = b.viewportMinimum + g, b.sessionVariables.newViewportMaximum = b.viewportMaximum + g, h = !0) : b.viewportMaximum > b.maximum && (g = b.viewportMaximum - b.maximum, b.sessionVariables.newViewportMinimum =
                    b.viewportMinimum - g, b.sessionVariables.newViewportMaximum = b.viewportMaximum - g, h = !0); else if ((!f || 2 < Math.abs(c)) && (!g || 2 < Math.abs(b)) && this.zoomEnabled) {
    ...
    z.prototype._plotAreaMouseMove = function (a, d) {
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            var b = 0, c = 0, f = b = null, f = 0 <= this.zoomType.indexOf("x"), g = 0 <= this.zoomType.indexOf("y"), h = this;
            ...
            if ((!f || 2 < Math.abs(b) || !g || 2 < Math.abs(c)) && (this.panEnabled || this.zoomEnabled))if (this.panEnabled)f = {
                ...
                var c = f ? this.dragStartPoint.x : this.plotArea.x1, l = g ? this.dragStartPoint.y : this.plotArea.y1, k = f ? a - this.dragStartPoint.x : this.plotArea.x2 - this.plotArea.x1, n = g ? d - this.dragStartPoint.y : this.plotArea.y2 -
                this.plotArea.y1;
    ...
    z.prototype.validateRegion = function (a, d, b, c, f) {
        ...
        for (g = 0; g < n.length; g++) {
            ...
            if (isFinite(h.dataInfo.minDiff))if (!(h.logarithmic && e / p < Math.pow(h.dataInfo.minDiff, 3) || !h.logarithmic && Math.abs(e - p) < 3 * Math.abs(h.dataInfo.minDiff) || p < h.minimum || e > h.maximum))k.push(h), m.push({
                val1: p,
                val2: e
            }), l = !0; else if (!f) {
                l = !1;
    ...
    z.prototype.renderIndexLabels = function (a) {
        ...
        for (a = 0; a < this._indexLabels.length; a++) {
            ...
            if (null !== t && "" !== t) {
                var w = S("indexLabelPlacement", n.dataPoint, n.dataSeries), y = S("indexLabelOrientation", n.dataPoint, n.dataSeries), C = n.direction, aa =
                    n.dataSeries.axisX, ca = n.dataSeries.axisY, z = !1, r = new X(d, {
                    x: 0,
                    y: 0,
                ...
                "horizontal" === y ? (l = r.width, k = r.height) : (k = r.width,
                    l = r.height);
                if ("normal" === this.plotInfo.axisPlacement) {
                    if (0 <= m.indexOf("line") || 0 <= m.indexOf("area"))w = "auto", h = 4; else if (0 <= m.indexOf("stacked"))"auto" === w && (w = "inside"); else if ("bubble" === m || "scatter" === m)w = "inside";
                    p = n.point.x - l / 2;
    ...
    z.prototype.renderLine = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var c = [], f = null, g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                if (d.setLineDash) {
                    var m = F(l.nullDataLineDashType, l.lineThickness), n = l.lineDashType, p = F(n, l.lineThickness);
                    d.setLineDash(p)
                }
                var e = l.id;
                ...
                d.beginPath();
                if (0 < k.length) {
                    for (var y = !1, s = 0; s < k.length; s++)if (u = k[s].x.getTime ? k[s].x.getTime() : k[s].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!l.connectNullData || !y)))if ("number" !== typeof k[s].y)0 < s && !(l.connectNullData || y || q) && (d.stroke(), v && b.stroke()), y = !0; else {
                        ...
                        if (0 < k[s].markerSize || 0 < l.markerSize) {
                            var C = l.getMarkerProperties(s, u, w, d), f = C.color;
                            c.push(C);
                            t = D(t);
                            v && c.push({
                                x: u,
            ...
            v && b.beginPath();
            return {
                source: d, dest: this.plotArea.ctx, animationCallback: E.xClipAnimation,
            ...
            for (var c = [], f = null, g = 0; g < a.dataSeriesIndexes.length; g++) {
                ...
                if (d.setLineDash) {
                    var m = F(l.nullDataLineDashType, l.lineThickness),
                        n = l.lineDashType, p = F(n, l.lineThickness);
                    d.setLineDash(p)
                }
                var e = l.id;
                ...
                d.beginPath();
                if (0 < k.length) {
                    for (var y = !1, s = 0; s < k.length; s++)if (u = k[s].getTime ? k[s].x.getTime() : k[s].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax &&
                        (!l.connectNullData || !y)))if ("number" !== typeof k[s].y)0 < s && !(l.connectNullData || y || q) && (d.stroke(), v && b.stroke()), y = !0; else {
                        var t = w;
                        u = a.axisX.convertValueToPixel(u);
                        w = a.axisY.convertValueToPixel(k[s].y);
    ...
    z.prototype.renderSpline = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var f = [], g = null, h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (b.setLineDash) {
                    var p = F(k.nullDataLineDashType, k.lineThickness), m = k.lineDashType, e = F(m, k.lineThickness);
                    b.setLineDash(e)
                }
                var r = k.id;
                ...
                var s = 0, u, w, y = [];
                b.beginPath();
                if (0 < n.length)for (w = !1, s = 0; s < n.length; s++)if (u = n[s].getTime ? n[s].x.getTime() : n[s].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !w)))if ("number" !== typeof n[s].y)0 < s && !w && (k.connectNullData ? b.setLineDash && (0 <
                y.length && (k.options.nullDataLineDashType || !n[s - 1].lineDashType)) && (y[y.length - 1].newLineDashArray = p, m = k.nullDataLineDashType) : (d(y), y = [])), w = !0; else {
                    u = a.axisX.convertValueToPixel(u);
                    ...
                    if (0 < n[s].markerSize || 0 < k.markerSize) {
                        var C = k.getMarkerProperties(s, u, w, b), g = C.color;
                        f.push(C);
                        t = D(t);
                        v && f.push({
                            x: u,
    ...
    z.prototype.renderColumn = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, c = this.plotArea, f = 0, g, h, l, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), f = this.dataPointMinWidth =
                this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, n = this.dataPointMaxWidth = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.width, 0.9 * (this.plotArea.width / a.plotType.totalDataSeries)) << 0, m = a.axisX.dataInfo.minDiff;
            ...
            for (c = 0; c < a.dataSeriesIndexes.length; c++) {
                ...
                if (0 < e.length)for (var r = 5 < m && p.bevelEnabled ? !0 : !1, f = 0; f < e.length; f++)if (e[f].getTime ? l = e[f].x.getTime() : l = e[f].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && "number" === typeof e[f].y) {
                    ...
                    c) * m << 0;
                    var q = a.axisX.reversed ? g - m << 0 : g + m << 0, s;
                    0 <= e[f].y ? s = k : (s = h, h = k);
                    h > s && (b = h, h = s, s = b);
    ...
    z.prototype.renderStackedColumn = function (a) {
        var d = a.targetCanvasCtx ||
            this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, c = this.plotArea, f = [], g = [], h = [], l = 0, k, n = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), l = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, m = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : 0.15 * this.width << 0, p = a.axisX.dataInfo.minDiff;
            ...
            for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                var e = a.dataSeriesIndexes[m], r = this.data[e], q = r.dataPoints;
                if (0 < q.length) {
                    ...
                    for (l = 0; l < q.length; l++)if (b = q[l].x.getTime ? q[l].x.getTime() : q[l].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[l].y) {
                        var c = a.axisX.convertValueToPixel(b), u = c - a.plotType.plotUnits.length * p /
                            2 + a.index * p << 0, w = u + p << 0, y;
                        if (a.axisY.logarithmic)h[b] = q[l].y + (h[b] ? h[b] : 0), 0 < h[b] && (k = a.axisY.convertValueToPixel(h[b]), y = f[b] ? f[b] : n, f[b] = k); else if (k = a.axisY.convertValueToPixel(q[l].y), 0 <= q[l].y) {
                            var t = f[b] ? f[b] : 0;
                            k -= t;
                            y = n - t;
                            f[b] = t + (y - k)
                        ...
                        this._eventManager.objectMap[b] = {
                            ...
                            dataPointIndex: l, x1: u, y1: k, x2: w, y2: y
                        };
                        b = D(b);
                        ...
                        (q[l].indexLabel || r.indexLabel || q[l].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                            ...
                            bounds: {x1: u, y1: Math.min(k, y), x2: w, y2: Math.max(k, y)},
                            color: b
                        })
                    }
                }
    ...
    z.prototype.renderStackedColumn100 = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                var e = a.dataSeriesIndexes[m], r = this.data[e], q = r.dataPoints;
                if (0 < q.length)for (var s = 5 < p && r.bevelEnabled ? !0 : !1, l = 0; l < q.length; l++)if (b = q[l].x.getTime ? q[l].x.getTime() : q[l].x, !(b < a.axisX.dataInfo.viewPortMin ||
                    ...
                    var u = c - a.plotType.plotUnits.length * p / 2 + a.index * p << 0, w = u + p << 0, y;
    ...
    z.prototype.renderBar = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, c = this.plotArea, f = 0, g, h, l, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                a.axisY.viewportMinimum : 0), f = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, n = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / a.plotType.totalDataSeries)) << 0, m = a.axisX.dataInfo.minDiff;
            isFinite(m) || (m = 0.3 * Math.abs(a.axisX.range));
            ...
            for (c = 0; c < a.dataSeriesIndexes.length; c++) {
                ...
                if (0 < e.length) {
                    ...
                    for (f = 0; f < e.length; f++)if (e[f].getTime ? l = e[f].x.getTime() : l = e[f].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && "number" === typeof e[f].y) {
                        ...
                        var q = a.axisX.reversed ? h - m << 0 : h + m << 0, s;
                        0 <= e[f].y ? s = k : (s = g, g = k);
                        b = e[f].color ? e[f].color : p._colorSet[f % p._colorSet.length];
    ...
    z.prototype.renderStackedBar = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b =
                null, c = this.plotArea, f = [], g = [], h = [], l = 0, k, n = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), l = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, m = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : 0.15 * this.height << 0, p = a.axisX.dataInfo.minDiff;
            isFinite(p) || (p = 0.3 * Math.abs(a.axisX.range));
            ...
            for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                if (0 < q.length) {
                    ...
                    d.strokeStyle = "#4572A7 ";
                    for (l = 0; l < q.length; l++)if (b = q[l].x.getTime ? q[l].x.getTime() : q[l].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[l].y) {
                        var c = a.axisX.convertValueToPixel(b), u = c - a.plotType.plotUnits.length * p / 2 + a.index * p << 0, w = u + p << 0, y;
                        if (a.axisY.logarithmic)h[b] =
                            q[l].y + (h[b] ? h[b] : 0), 0 < h[b] && (y = f[b] ? f[b] : n, f[b] = k = a.axisY.convertValueToPixel(h[b])); else if (k = a.axisY.convertValueToPixel(q[l].y), 0 <= q[l].y) {
                            var t = f[b] ? f[b] : 0;
                            y = n + t;
                            k += t;
                            f[b] = t + (k - y)
                        ...
                        (q[l].indexLabel || r.indexLabel || q[l].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                            ...
                            direction: 0 > q[l].y === a.axisY.reversed ? 1 : -1,
                            bounds: {x1: Math.min(y, k), y1: u, x2: Math.max(y, k), y2: w},
                            color: b
                        })
                    }
                }
    ...
    z.prototype.renderStackedBar100 = function (a) {
        var d = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var b = null, c = this.plotArea, f = [], g = [], h = [], l = 0, k, n = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), l = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1, m = this.dataPointMaxWidth ? this.dataPointMaxWidth : this.dataPointWidth ? this.dataPointWidth : 0.15 * this.height << 0, p = a.axisX.dataInfo.minDiff;
            isFinite(p) ||
            ...
            for (m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                if (0 < q.length) {
                    ...
                    d.strokeStyle = "#4572A7 ";
                    for (l = 0; l < q.length; l++)if (b = q[l].x.getTime ? q[l].x.getTime() : q[l].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[l].y) {
                        var c = a.axisX.convertValueToPixel(b), u;
                        ...
                        (q[l].indexLabel || r.indexLabel || q[l].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                            ...
                            dataPoint: q[l],
                            dataSeries: r,
                            point: {x: 0 <= q[l].y ? k : u, y: c},
                            direction: 0 > q[l].y === a.axisY.reversed ? 1 : -1,
                            bounds: {
                                x1: Math.min(u, k),
                                y1: w, x2: Math.max(u, k), y2: y
                            },
                            color: b
                        })
                    }
    ...
    z.prototype.renderArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                h = D(h);
                c.fillStyle = h;
                var h = [], e = !0, r = 0, q, s, u, w = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), y, t = null;
                if (0 < p.length) {
                    var C = m._colorSet[r % m._colorSet.length], x = m.lineColor = m.options.lineColor || C, ca = x;
                    b.fillStyle = C;
                    b.strokeStyle = x;
                    b.lineWidth = m.lineThickness;
                    var z = "solid";
                    if (b.setLineDash) {
                        var A = F(m.nullDataLineDashType, m.lineThickness), z = m.lineDashType, K = F(z, m.lineThickness);
                        b.setLineDash(K)
                    }
                    for (var I = !0; r < p.length; r++)if (u = p[r].x.getTime ? p[r].x.getTime() : p[r].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !I)))if ("number" !== typeof p[r].y)m.connectNullData || (I || e) || d(), I = !0; else {
    ...
    z.prototype.renderSplineArea = function (a) {
        function d() {
            ...
            if (0 < d.length) {
                if (0 < m.lineThickness) {
                    ...
                    for (var e = 0; e < d.length - 3; e += 3)if (b.bezierCurveTo(d[e + 1].x, d[e + 1].y, d[e + 2].x, d[e + 2].y, d[e + 3].x, d[e + 3].y), v && c.bezierCurveTo(d[e + 1].x, d[e + 1].y, d[e + 2].x, d[e + 2].y, d[e + 3].x, d[e + 3].y), d[e + 3].newStrokeStyle || d[e + 3].newLineDashArray)b.stroke(), b.beginPath(), b.moveTo(d[e + 3].x, d[e + 3].y), d[e + 3].newStrokeStyle && (b.strokeStyle = d[e + 3].newStrokeStyle), d[e + 3].newLineDashArray && b.setLineDash(d[e + 3].newLineDashArray);
                    b.stroke()
                }
                b.beginPath();
                b.moveTo(d[0].x,
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                var n = a.dataSeriesIndexes[k], m = this.data[n], p = m.dataPoints,
                    h = m.id;
                this._eventManager.objectMap[h] = {objectType: "dataSeries", dataSeriesIndex: n};
                h = D(h);
                c.fillStyle = h;
                var h = [], e = 0, r, q, s = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), u, w = null, y = [];
                if (0 < p.length) {
                    var t = m._colorSet[e % m._colorSet.length], C = m.lineColor = m.options.lineColor || t, x = C;
                    b.fillStyle = t;
                    b.strokeStyle = C;
                    b.lineWidth = m.lineThickness;
                    var z = "solid";
                    if (b.setLineDash) {
                        var A = F(m.nullDataLineDashType, m.lineThickness), z = m.lineDashType, Q = F(z, m.lineThickness);
                        b.setLineDash(Q)
                    }
                    for (q = !1; e < p.length; e++)if (r = p[e].x.getTime ? p[e].x.getTime() : p[e].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !q)))if ("number" !== typeof p[e].y)0 < e && !q && (m.connectNullData ? b.setLineDash && (0 < y.length && (m.options.nullDataLineDashType || !p[e - 1].lineDashType)) && (y[y.length - 1].newLineDashArray = A, z = m.nullDataLineDashType) : (d(), y = [])), q = !0; else {
                        r = a.axisX.convertValueToPixel(r);
                        q = a.axisY.convertValueToPixel(p[e].y);
                        var K = m.dataPointIds[e];
                        this._eventManager.objectMap[K] =
                        {id: K, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: e, x1: r, y1: q};
                        y[y.length] = {x: r, y: q};
                        ...
                        if (0 !== p[e].markerSize && (0 < p[e].markerSize || 0 < m.markerSize)) {
                            var I = m.getMarkerProperties(e, r, q, b), l = I.color;
                            h.push(I);
                            K = D(K);
                            v && h.push({
                                x: r,
    ...
    z.prototype.renderStepArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                h = D(h);
                c.fillStyle = h;
                var h = [], e = !0, r = 0, q, s, u, w = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), y, t = null, C = !1;
                if (0 < p.length) {
                    var x = m._colorSet[r % m._colorSet.length], z = m.lineColor = m.options.lineColor || x, A = z;
                    b.fillStyle = x;
                    b.strokeStyle = z;
                    b.lineWidth = m.lineThickness;
                    var Q = "solid";
                    if (b.setLineDash) {
                        var K = F(m.nullDataLineDashType, m.lineThickness), Q = m.lineDashType, I = F(Q, m.lineThickness);
                        b.setLineDash(I)
                    }
                    for (; r < p.length; r++)if (u = p[r].x.getTime ? p[r].x.getTime() :
                        ...
                        "number" !== typeof p[r].y ? (m.connectNullData || (C || e) || d(), C = !0) : (q = a.axisX.convertValueToPixel(u), s = a.axisY.convertValueToPixel(p[r].y), e || C ? (!e && m.connectNullData ? (b.setLineDash && (m.options.nullDataLineDashType || Q === m.lineDashType && m.lineDashType !== m.nullDataLineDashType) && (b.stroke(), Q = m.nullDataLineDashType, b.setLineDash(K)), b.lineTo(q, G), b.lineTo(q, s), v && (c.lineTo(q, G), c.lineTo(q, s))) : (b.beginPath(),
                            ...
                            id: G, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: r,
                            x1: q, y1: s
                        }, 0 !== p[r].markerSize && (0 < p[r].markerSize || 0 < m.markerSize) && (u = m.getMarkerProperties(r, q, s, b), l = u.color, h.push(u), G = D(G), v && h.push({
                            x: q,
                            y: s,
    ...
    z.prototype.renderStackedArea = function (a) {
        ...
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null, f = [], g = null, h = this.plotArea, l = [], k = [], n = [], m = [], p = 0, e, r, q, s = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), u = this._eventManager.ghostCtx;
            v && u.beginPath();
            b.save();
            v && u.save();
            b.beginPath();
            ...
            for (var w = [], h = 0; h < a.dataSeriesIndexes.length; h++) {
                var y = a.dataSeriesIndexes[h], t = this.data[y], C = t.dataPoints;
                t.dataPointIndexes =
                    [];
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                u.fillStyle = p;
                if (0 < n.length) {
                    var c = t._colorSet[0], x = t.lineColor = t.options.lineColor || c, z = x;
                    b.fillStyle = c;
                    b.strokeStyle = x;
                    ...
                    if (b.setLineDash) {
                        var Q =
                            F(t.nullDataLineDashType, t.lineThickness), A = t.lineDashType, K = F(A, t.lineThickness);
                        b.setLineDash(K)
                    }
                    for (var I = !0, p = 0; p < n.length; p++) {
                        q = n[p];
                        var G = null, G = 0 <= t.dataPointIndexes[q] ? C[t.dataPointIndexes[q]] : {x: q, y: null};
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !I)))if ("number" !== typeof G.y)t.connectNullData || (I || w) || d(), I = !0; else {
    ...
    z.prototype.renderStackedArea100 = function (a) {
        ...
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null, f = this.plotArea, g = [], h = null, l = [], k = [], n = [], m = [], p = 0, e, r, q, s = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), u = this._eventManager.ghostCtx;
            b.save();
            v && u.save();
            b.beginPath();
            b.rect(f.x1, f.y1, f.width, f.height);
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                if (0 < n.length) {
                    ...
                    if (b.setLineDash) {
                        var Q =
                            F(t.nullDataLineDashType, t.lineThickness), T = t.lineDashType, K = F(T, t.lineThickness);
                        b.setLineDash(K)
                    }
                    for (var I = !0, p = 0; p < n.length; p++) {
                        q = n[p];
                        var G = null, G = 0 <= t.dataPointIndexes[q] ? x[t.dataPointIndexes[q]] : {x: q, y: null};
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !I)))if ("number" !== typeof G.y)t.connectNullData || (I || w) || d(), I = !0; else {
                            var ga;
                            ...
                            w || I ? (!w && t.connectNullData ? (b.setLineDash && (t.options.nullDataLineDashType || T === t.lineDashType && t.lineDashType !== t.nullDataLineDashType) && (b.stroke(), T = t.nullDataLineDashType, b.setLineDash(Q)), b.lineTo(e, r), v && u.lineTo(e, r)) : (b.beginPath(), b.moveTo(e, r), v && (u.beginPath(), u.moveTo(e, r))), I = w = !1) : (b.lineTo(e, r), v && u.lineTo(e, r), 0 == p % 250 && (d(), b.moveTo(e,
                                r), v && u.moveTo(e, r), k.push({x: e, y: s - ha})));
    ...
    z.prototype.renderBubble = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var h = -Infinity, l = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++)for (var n = a.dataSeriesIndexes[k], m = this.data[n], p = m.dataPoints, e = 0, c = 0; c < p.length; c++)f = p[c].getTime ? f = p[c].x.getTime() : f = p[c].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof p[c].z || (e = p[c].z, e > h && (h = e), e < l && (l = e));
            for (var r = 25 * Math.PI, b = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI,
                r), k = 0; k < a.dataSeriesIndexes.length; k++)if (n = a.dataSeriesIndexes[k], m = this.data[n], p = m.dataPoints, 0 < p.length)for (d.strokeStyle = "#4572A7 ", c = 0; c < p.length; c++)if (f = p[c].getTime ? f = p[c].x.getTime() : f = p[c].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof p[c].y) {
                f = a.axisX.convertValueToPixel(f);
                g = a.axisY.convertValueToPixel(p[c].y);
                var e = p[c].z, q = 2 * Math.max(Math.sqrt((h === l ? b / 2 : r + (b - r) / (h - l) * (e - l)) / Math.PI) << 0, 1), e = m.getMarkerProperties(c, d);
                e.size = q;
                d.globalAlpha =
                    m.fillOpacity;
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (0 < n.length) {
                    ...
                    for (var m = 0, p = 0, c = 0; c < n.length; c++)if (f = n[c].getTime ? f = n[c].x.getTime() : f = n[c].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[c].y) {
                        f = a.axisX.convertValueToPixel(f);
    ...
    z.prototype.renderCandlestick = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null, c = this.plotArea, f = 0, g, h, l, k, n, m, f = this.dataPointMinWidth ? this.dataPointMinWidth : this.dataPointWidth ? this.dataPointWidth : 1;
            ...
            for (var e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                if (0 < s.length)for (var u = 5 < p && q.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++)if (s[f].getTime ? m = s[f].x.getTime() : m = s[f].x, !(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) && null !== s[f].y && s[f].y.length && "number" === typeof s[f].y[0] && "number" === typeof s[f].y[1] && "number" === typeof s[f].y[2] && "number" === typeof s[f].y[3]) {
                    ...
                    (s[f].indexLabel || q.indexLabel || s[f].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({
                        ...
                        direction: 1,
                        bounds: {
                            x1: w, y1: Math.min(l, k), x2: y, y2: Math.max(l,
                                k)
                        },
                        color: c
                    })
    ...
    z.prototype.renderRangeColumn = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var k = 0; k < a.dataSeriesIndexes.length; k++) {
                var n = a.dataSeriesIndexes[k], m = this.data[n], p = m.dataPoints;
                if (0 < p.length)for (var e = 5 < l && m.bevelEnabled ? !0 : !1, f = 0; f < p.length; f++)if (p[f].getTime ? h = p[f].x.getTime() : h = p[f].x, !(h < a.axisX.dataInfo.viewPortMin ||
                    ...
                    var r = a.axisX.reversed ? b + a.plotType.totalDataSeries * l / 2 - (a.previousDataSeriesCount + k) * l << 0 : b - a.plotType.totalDataSeries * l / 2 + (a.previousDataSeriesCount + k) * l << 0, q = a.axisX.reversed ? r - l << 0 : r + l << 0, b = p[f].color ? p[f].color : m._colorSet[f % m._colorSet.length];
                    if (c > g) {
                        var s = c,
                            c = g;
                        g = s
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < e.length) {
                        ...
                        d.strokeStyle = "#4572A7 ";
                        for (f = 0; f < e.length; f++)if (e[f].getTime ? l = e[f].x.getTime() : l = e[f].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && null !== e[f].y && e[f].y.length && "number" === typeof e[f].y[0] && "number" === typeof e[f].y[1]) {
                            ...
                            if (e[f].indexLabel || p.indexLabel || e[f].indexLabelFormatter || p.indexLabelFormatter)this._indexLabels.push({
                                ...
                                dataSeries: p,
                                indexKeyword: 0,
                                point: {x: e[f].y[1] >= e[f].y[0] ? c : g, y: h + (q - h) / 2},
    ...
    z.prototype.renderRangeArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                f = D(f);
                c.fillStyle = f;
                var f = [], p = !0, e = 0, r, q, s, u, w = null;
                if (0 < m.length) {
                    var y = n._colorSet[e % n._colorSet.length], t = n.lineColor = n.options.lineColor || y, x = t;
                    b.fillStyle = y;
                    b.strokeStyle = t;
                    ...
                    if (b.setLineDash) {
                        var A = F(n.nullDataLineDashType, n.lineThickness),
                            z = n.lineDashType, T = F(z, n.lineThickness);
                        b.setLineDash(T)
                    }
                    for (var Q = !0; e < m.length; e++)if (u = m[e].x.getTime ? m[e].x.getTime() : m[e].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !Q)))if (null !== m[e].y && m[e].y.length && "number" === typeof m[e].y[0] && "number" === typeof m[e].y[1]) {
    ...
    z.prototype.renderRangeSplineArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c =
                this._eventManager.ghostCtx, f = [], g = null, h = this.plotArea;
            b.save();
            v && c.save();
            b.beginPath();
            b.rect(h.x1, h.y1, h.width, h.height);
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                var f = [], m = 0, p, e, r, q = [], s = [];
                if (0 < n.length) {
                    var u = k._colorSet[m % k._colorSet.length], w = k.lineColor =
                        k.options.lineColor || u, y = w;
                    b.fillStyle = u;
                    b.lineWidth = k.lineThickness;
                    var t = "solid", x;
                    if (b.setLineDash) {
                        var z = F(k.nullDataLineDashType, k.lineThickness), t = k.lineDashType;
                        x = F(t, k.lineThickness)
                    }
                    for (e = !1; m < n.length; m++)if (p = n[m].x.getTime ? n[m].x.getTime() : n[m].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !e)))if (null !== n[m].y && n[m].y.length && "number" === typeof n[m].y[0] && "number" === typeof n[m].y[1]) {
                        ...
                        if (0 !== n[m].markerSize && (0 < n[m].markerSize || 0 < k.markerSize)) {
                            var T = k.getMarkerProperties(m, p, e, b), g = T.color;
                            f.push(T);
                            var Q = D(A);
                            v && f.push({
                                x: p,
    ...
    z.prototype.renderPie = function (a) {
        function d() {
            if (n && m) {
                for (var a = 0, b = 0, c = 0, d = 0, f = 0; f < m.length; f++) {
                    var g = m[f], h = n.dataPointIds[f], l = {
                        id: h,
                        objectType: "dataPoint",
                        dataPointIndex: f,
                        dataSeriesIndex: 0
                    ...
                    r.push(l);
                    var p = {percent: null, total: null}, q = null, p = k.getPercentAndTotal(n, g);
                    ...
                    l.indexLabelTextBlock = new X(k.plotArea.ctx, {
                        ...
                        maxHeight: l.indexLabelWrap ? 5 * l.indexLabelFontSize :
        ...
        function b(a) {
            ...
            for (b = 0; b < m.length; b++) {
                ...
                if (d > c) {
                    var f = 0.07 * A * Math.cos(r[b].midAngle), g = 0.07 * A * Math.sin(r[b].midAngle), l = !1;
                    if (m[b].exploded) {
        ...
        function f(a) {
            for (var b = null, d = 1; d < m.length; d++)if (b = (a + d + r.length) % r.length, r[b].hemisphere !== r[a].hemisphere) {
                b = null;
                break
            } else if (r[b].indexLabelText && b !== a && (0 > c(r[b], r[a]) || ("right" === r[a].hemisphere ? r[b].indexLabelTextBlock.y >= r[a].indexLabelTextBlock.y : r[b].indexLabelTextBlock.y <= r[a].indexLabelTextBlock.y)))break; else b = null;
            return b
        }
        ...
        function g(a, b, d) {
            ...
            if (0 <= a && a < m.length) {
                ...
                k = null;
                for (l = 1; l < m.length; l++)if (k = (a - l + r.length) % r.length, r[k].hemisphere !== r[a].hemisphere) {
                    k = null;
                    break
                } else if (r[k].indexLabelText && r[k].hemisphere ===
                    r[a].hemisphere && k !== a && (0 > c(r[k], r[a]) || ("right" === r[a].hemisphere ? r[k].indexLabelTextBlock.y <= r[a].indexLabelTextBlock.y : r[k].indexLabelTextBlock.y >= r[a].indexLabelTextBlock.y)))break; else k = null;
                p = k;
                n = f(a);
                l = k = 0;
        ...
        function h() {
            ...
            for (var b = a = 0, d = 0, l = !0, b = 0; 10 > b && (1 > b || 0 < d); b++) {
                    ...
                    for (var w, v, a = 0; a < m.length; a++) {
                        ...
                        if (null !== x) {
                            ...
                            if (0 > z) {
                                ...
                                v = z / (v + C || 1) * C;
                                var C = -1 * (z - v), B = D = 0;
                                "right" === h.hemisphere ? (D = g(a, v), C = -1 * (z - D), B = g(x, C), +B.toFixed(y) < +C.toFixed(y) && +D.toFixed(y) <= +v.toFixed(y) && g(a, -(C - B))) : (D = g(x, v), C = -1 * (z - D), B = g(a, C), +B.toFixed(y) < +C.toFixed(y) && +D.toFixed(y) <= +v.toFixed(y) && g(x, -(C - B)))
                            }
                        }
                    }
                } else for (a = 0; a < m.length; a++)h = r[a], s = "pie" === n.type ? 0.7 * A : 0.8 * A, x = t.x + s * Math.cos(h.midAngle), v = t.y + s * Math.sin(h.midAngle), h.indexLabelTextBlock.x = x, h.indexLabelTextBlock.y = v;
                for (a = 0; a < m.length; a++)if (h = r[a], x = h.indexLabelTextBlock.measureText(), 0 !== x.height && 0 !== x.width)x = x = 0, "right" === h.hemisphere ? (x = e.x2 - (h.indexLabelTextBlock.x + h.indexLabelTextBlock.width +
                ...
                (function () {
                    for (var a = -1, b = -1, d = 0, e = !1, g = 0; g < m.length; g++)if (e = !1, w = r[g], w.indexLabelText) {
                        var h = f(g);
                        if (null !== h) {
                            var k = r[h];
                            z = 0;
                            ...
                            if (l = 0 > z) {
                                ...
                                var n = w.indexLabelTextBlock.y - w.indexLabelTextBlock.height /
                                    2, q = w.indexLabelTextBlock.y + w.indexLabelTextBlock.height / 2, s = k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2, t = k.indexLabelTextBlock.x + k.indexLabelTextBlock.width, u = k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2;
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var n = this.data[a.dataSeriesIndexes[0]],
                m = n.dataPoints, p = 10, e = this.plotArea, r = [], q = 2, s, u = 1.3, w = 20 / 180 * Math.PI, y = 6, t = {
                    x: (e.x2 + e.x1) / 2,
                    y: (e.y2 + e.y1) / 2
                }, v = 0;
            a = !1;
    ...
    X.prototype._wrapText = function () {
        var a = new String(ma(String(this.text))), d = [], b = this.ctx.font, c = 0, f = 0;
        for (this.ctx.font = this._getFontString(); 0 < a.length;) {
            var g = this.maxHeight - 2 * this.padding, h = this._getLineWithWidth(a, this.maxWidth - 2 * this.padding,
                !1);
            h.height = this._lineHeight;
            d.push(h);
            var l = f, f = Math.max(f, h.width), c = c + h.height, a = ma(a.slice(h.text.length, a.length));
    ...
    oa.prototype.render = function () {
        if (this.text) {
            var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, d = a.layoutManager.getFreeSpace(), b = d.x1, c = d.y1, f = 0, g = 0, h = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, l, k;
    ...
    ya.prototype.render = function () {
        var a = this.dockInsidePlotArea ?
            this.chart.plotArea : this.chart, d = a.layoutManager.getFreeSpace(), b = null, c = 0, f = 0, g = 0, h = 0, l = this.markerMargin = this.chart.options.legend && !x(this.chart.options.legend.markerMargin) ? this.chart.options.legend.markerMargin : 0.3 * this.fontSize;
        this.height = 0;
        var k = [], n = [];
        ...
        for (var m = 0; m < this.dataSeries.length; m++) {
            ...
            if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type) {
                var e = p.legendMarkerType = p.legendMarkerType ? p.legendMarkerType : "line" !== p.type && "stepLine" !== p.type && "spline" !== p.type && "scatter" !== p.type && "bubble" !== p.type || !p.markerType ? ba.getDefaultLegendMarker(p.type) :
                    ...
                    dataSeries: p,
                    dataPoint: null
                }) : p.name, q = p.legendMarkerColor = p.legendMarkerColor ? p.legendMarkerColor : p.markerColor ? p.markerColor : p._colorSet[0], s = p.markerSize || "line" !== p.type && "stepLine" !== p.type && "spline" !== p.type ? 0.75 * this.lineHeight : 0, u = p.legendMarkerBorderColor ? p.legendMarkerBorderColor : p.markerBorderColor, w = p.legendMarkerBorderThickness ? p.legendMarkerBorderThickness : p.markerBorderThickness ?
                    Math.max(1, Math.round(0.2 * s)) : 0, r = this.chart.replaceKeywordsWithValue(r, p.dataPoints[0], p, m), e = {
                    markerType: e,
                    markerColor: q,
                    text: r,
                    textBlock: null,
                ...
                k.push(e)
            } else for (var v = 0; v < p.dataPoints.length; v++) {
                var t = p.dataPoints[v], e = t.legendMarkerType ? t.legendMarkerType : p.legendMarkerType ? p.legendMarkerType : ba.getDefaultLegendMarker(p.type), r = t.legendText ? t.legendText :
                        p.legendText ? p.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                            chart: this.chart,
                            legend: this.options,
                            dataSeries: p,
                            dataPoint: t
                        }) : t.name ? t.name : "DataPoint: " + (v + 1), q = t.legendMarkerColor ? t.legendMarkerColor : p.legendMarkerColor ? p.legendMarkerColor : t.color ? t.color : p.color ? p.color : p._colorSet[v % p._colorSet.length], s = 0.75 * this.lineHeight, u = t.legendMarkerBorderColor ? t.legendMarkerBorderColor : p.legendMarkerBorderColor ? p.legendMarkerBorderColor : t.markerBorderColor ? t.markerBorderColor : p.markerBorderColor,
                    w = t.legendMarkerBorderThickness ? t.legendMarkerBorderThickness : p.legendMarkerBorderThickness ? p.legendMarkerBorderThickness : t.markerBorderThickness || p.markerBorderThickness ? Math.max(1, Math.round(0.2 * s)) : 0, r = this.chart.replaceKeywordsWithValue(r, t, p, v), e = {
                        markerType: e,
                        markerColor: q,
                        text: r,
                        textBlock: null,
        ...
        for (m = 0; m < this.items.length; m++)e = k[m], e.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[e.id] = {
            id: e.id, objectType: "legendItem",
            legendItemIndex: m, dataSeriesIndex: e.dataSeriesIndex, dataPointIndex: e.dataPointIndex
        };
    ...
    ba.prototype.getDataPointAtX = function (a, d) {
        ...
        var b = {
            ...
            distance: Infinity,
            index: NaN
        }, c = null, f = 0, g = 0, h = 1, l = Infinity, k = 0, n = 0, m = 0;
    ...
    ba.prototype.getDataPointAtXY = function (a, d, b) {
        ...
        for (; ;) {
            ...
            if (0 <= g && g < this.dataPoints.length) {
                var e =
                    this.chart._eventManager.objectMap[this.dataPointIds[g]], r = this.dataPoints[g], q = null;
                if (e) {
                    switch (this.type) {
                        case "column":
                        case "stackedColumn":
                        ...
                        case "scatter":
                            var s =
                                S("markerSize", r, this) || 4, u = b ? 20 : s, q = Math.sqrt(Math.pow(e.x1 - a, 2) + Math.pow(e.y1 - d, 2));
                            q <= u && c.push({dataPoint: r, dataPointIndex: g, dataSeries: this, distance: q});
                            g = Math.abs(e.x1 - a);
                            g <= k ? k = g : 0 < h ? n++ : m++;
                            q <= s / 2 && (l = !0);
                            break;
                        ...
                        case "candlestick":
                            if (a >= e.x1 - e.borderThickness / 2 && a <= e.x2 + e.borderThickness / 2 && d >= e.y2 - e.borderThickness / 2 && d <= e.y3 + e.borderThickness / 2 || Math.abs(e.x2 - a + e.x1 - a) < e.borderThickness && d >= e.y1 && d <= e.y4)c.push({
                                dataPoint: r, dataPointIndex: g, dataSeries: this, distance: Math.min(Math.abs(e.x1 -
                ...
                p + f >= this.dataPoints.length)break;
            -1 === h ? (f++, h = 1) : h = -1
        }
        a = null;
    ...
    A.prototype.createLabels = function () {
        ...
        if (this.dataSeries && 0 < this.dataSeries.length)for (c = 0; c < this.dataSeries.length; c++)"dateTime" === this.dataSeries[c].xValueType && (b = !0);
        if ("axisX" === this.type && b && !this.logarithmic)for (this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum),
        ...
        f = [];
        p = l = 0;
        if (this.labelAutoFit || this.options.labelAutoFit)if (x(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ?
                this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position)if (g = 0.9 * k >> 0, p = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
            ...
            for (b = this.intervalStartPosition < this.viewportMinimum ? 1 : 0; b < this._labels.length; b++)if (a = this._labels[b].textBlock, r = a.measureText(), b < this._labels.length - 1 && (e = b + 1, d = this._labels[e].textBlock, d = d.measureText()), f.push(a.height), this.sessionVariables.labelMaxHeight = Math.max.apply(Math, f), Math.cos(Math.PI / 180 * Math.abs(this.labelAngle)),
                ...
                if (x(this.options.labelWrap))if (!x(this.options.labelMaxWidth))this.options.labelMaxWidth <
                g ? (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = c) : (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = h); else if (!x(d))if (c = r.width + d.width >> 0, e = this.labelFontSize, p < g)c - 2 * g > l && (l = c - 2 * g, c >= 2 * g && c < 2.2 * g ? (this.sessionVariables.labelMaxWidth = g, x(this.options.labelFontSize) && 12 < e && (e = Math.floor(12 / 13 * e), a.measureText()), this.sessionVariables.labelFontSize = x(this.options.labelFontSize) ?
                    ...
                    e : this.options.labelFontSize, this.sessionVariables.labelAngle = this.labelAngle) : c >= 3.2 * g && c < 3.6 * g ? (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = s, this.sessionVariables.labelFontSize = this.labelFontSize) : c > 3.6 * g && c < 5 * g ? (x(this.options.labelFontSize) && 12 < e && (e = Math.floor(12 / 13 * e), a.measureText()), this.sessionVariables.labelFontSize = x(this.options.labelFontSize) ? e : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = s) : c > 5 * g && (this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = g, this.sessionVariables.labelFontSize = e, this.sessionVariables.labelMaxHeight = h, this.sessionVariables.labelAngle = this.labelAngle)); else if (q === b && (0 === q && p + this._labels[q + 1].textBlock.measureText().width - 2 * g > l || q === this._labels.length - 1 && p + this._labels[q - 1].textBlock.measureText().width - 2 * g > l || 0 < q && q < this._labels.length - 1 && p + this._labels[q + 1].textBlock.measureText().width - 2 * g > l &&
    ...
    A.prototype.createLabelsAndCalculateHeight = function () {
        ...
        if ("bottom" === this._position || "top" === this._position) {
            for (b = 0; b < this._labels.length; b++) {
                ...
                var c = d.measureText(), f = 0, f = 0 === this.labelAngle ? c.height : c.width * Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)) + (c.height -
    ...
    A.setLayoutAndRender = function (a, d, b, c, f, g) {
        ...
        var r = 0, q = 0, s = 0, u = 0, w = 0, v = 0, t = 0, z, A, D = l = 0, E, F, K,
            I;
        E = F = K = I = !1;
        if (a && 0 < a.length)for (e = 0; e < a.length; e++)a[e] && a[e].title && (a[e]._titleTextBlock = new X(a[e].ctx, {
            text: a[e].title,
            horizontalAlign: "center",
        ...
        if (d && 0 < d.length)for (e = 0; e < d.length; e++)d[e] && d[e].title && (d[e]._titleTextBlock = new X(d[e].ctx, {
            text: d[e].title,
            horizontalAlign: "center",
        ...
        if (b && 0 < b.length)for (e = 0; e < b.length; e++)b[e] && b[e].title && (b[e]._titleTextBlock = new X(b[e].ctx, {
            text: b[e].title,
            horizontalAlign: "center",
        ...
        if (c && 0 < c.length)for (e = 0; e < c.length; e++)c[e] && c[e].title && (c[e]._titleTextBlock =
            new X(c[e].ctx, {
                text: c[e].title,
                horizontalAlign: "center",
        ...
        if ("normal" === f) {
            var u = [], w = [], v = [], t = [], G = [], H = [], J = [], M = [];
            if (a && 0 < a.length)for (e = 0; e < a.length; e++)a[e] && a[e].title && (a[e]._titleTextBlock.maxWidth = a[e].titleMaxWidth || g.width, a[e]._titleTextBlock.maxHeight = a[e].titleWrap ? 0.8 * g.height : 1.5 * a[e].titleFontSize, a[e]._titleTextBlock.angle =
                0);
            if (d && 0 < d.length)for (e = 0; e < d[e].length; e++)d[e] && d[e].title && (d[e]._titleTextBlock.maxWidth = d[e].titleMaxWidth || g.width, d[e]._titleTextBlock.maxHeight = d[e].titleWrap ? 0.8 * g.height : 1.5 * d[e].titleFontSize, d[e]._titleTextBlock.angle = 0);
            ...
            for (; 4 > r;) {
                var L = 0, R = 0, P = 0, O = 0, N = f = 0, B = 0, S = 0, Y = 0, W = 0, V = 0, U = 0;
                if (b && 0 < b.length)for (v = [], e = V = 0; e < b.length; e++)v.push(Math.ceil(b[e] ? b[e].createLabelsAndCalculateWidth() : 0)), V += v[e], B += b[e] ? b[e].margin : 0; else v.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateWidth() : 0));
                J.push(v);
                if (c && 0 < c.length)for (t = [], e = U = 0; e < c.length; e++)t.push(Math.ceil(c[e] ?
                    c[e].createLabelsAndCalculateWidth() : 0)), U += t[e], S += c[e] ? c[e].margin : 0; else t.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
                M.push(t);
                h = Math.round(g.x1 + V + B);
                k = Math.round(g.x2 - U - S > m.width - 10 ? m.width - 10 : g.x2 - U - S);
                if (a && 0 < a.length)for (u = [], e = Y = 0; e < a.length; e++)a[e] && (a[e].lineCoordinates = {}), a[e].lineCoordinates.width = Math.abs(k - h), a[e].title && (a[e]._titleTextBlock.maxWidth = 0 < a[e].titleMaxWidth && a[e].titleMaxWidth < a[e].lineCoordinates.width ? a[e].titleMaxWidth : a[e].lineCoordinates.width),
                    u.push(Math.ceil(a[e] ? a[e].createLabelsAndCalculateHeight() : 0)), Y += u[e], f += a[e] ? a[e].margin : 0; else u.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateHeight() : 0));
                G.push(u);
                if (d && 0 < d.length)for (w = [], e = W = 0; e < d.length; e++)d[e] && (d[e].lineCoordinates = {}), d[e].lineCoordinates.width = Math.abs(k - h), d[e].title && (d[e]._titleTextBlock.maxWidth = 0 < d[e].titleMaxWidth && d[e].titleMaxWidth < d[e].lineCoordinates.width ? d[e].titleMaxWidth : d[e].lineCoordinates.width), w.push(Math.ceil(d[e] ? d[e].createLabelsAndCalculateHeight() :
                    0)), W += w[e], N += d[e] ? d[e].margin : 0; else w.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateHeight() : 0));
                H.push(w);
                if (a && 0 < a.length)for (e = 0; e < a.length; e++)a[e] && (a[e].lineCoordinates.x1 = h, a[e].lineCoordinates.x2 = Math.round(g.x2 - U - S > m.width - 10 ? m.width - 10 : g.x2 - U - S), a[e]._labels && 1 < a[e]._labels.length && (l = n = 0, n = a[e]._labels[1], l = "dateTime" === a[e].chart.plotInfo.axisXValueType ? a[e]._labels[a[e]._labels.length - 2] : a[e]._labels[a[e]._labels.length - 1], q = n.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(n.textBlock.angle)) +
                ...
                if (d && 0 < d.length)for (e = 0; e < d.length; e++)d[e].lineCoordinates.x1 = Math.round(g.x1 + V + B), d[e].lineCoordinates.x2 = Math.round(g.x2 - U - S > m.width - 10 ? m.width - 10 : g.x2 - U - S), d[e].lineCoordinates.width = Math.abs(k - h), d[e]._labels && 1 < d[e]._labels.length && (n = d[e]._labels[1], l = "dateTime" === d[e].chart.plotInfo.axisXValueType ?
                ...
                if (b && 0 < b.length)for (e = 0; e < b.length; e++)B = 10, b[e] && (h = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), B = b[e]._labels && 0 < b[e]._labels.length ? b[e]._labels[b[e]._labels.length - 1].textBlock.height / 2 : 10, l = Math.round(g.y1 + W + N < Math.max(B, 10) ? Math.max(B, 10) : g.y1 + W + N), k = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1),
                ...
                if (c && 0 < c.length)for (e = 0; e < c.length; e++)c[e] && (h = Math.round(a[0] ? a[0].lineCoordinates.x2 : d[0].lineCoordinates.x2),
                ...
                if (0 < r) {
                    if (a && 0 < a.length)for (e = 0; e < a.length; e++)E = G[r - 1][e] === G[r][e] ? !0 : !1; else E = !0;
                    if (d && 0 < d.length)for (e = 0; e < d.length; e++)F = H[r - 1][e] === H[r][e] ? !0 : !1; else F = !0;
                    if (b && 0 < b.length)for (e = 0; e < b.length; e++)K = J[r - 1][e] === J[r][e] ? !0 : !1; else K = !0;
                    if (c && 0 < c.length)for (e = 0; e < c.length; e++)I = M[r - 1][e] === M[r][e] ? !0 : !1; else I = !0
                }
                if (E && F && K && I)break;
                r++
            }
            ...
            if (b && 0 < b.length)for (e = 0; e < b.length; e++)b[e] && b[e].title && (b[e]._titleTextBlock.maxWidth =
            ...
            for (; 4 > r;) {
                ...
                if (a && 0 < a.length)for (D = [], e = Y = 0; e < a.length; e++)D.push(Math.ceil(a[e] ? a[e].createLabelsAndCalculateWidth() :
                    0)), Y += D[e], f += a[e] ? a[e].margin : 0; else D.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
                H.push(D);
                if (d && 0 < d.length)for (q = [], e = W = 0; e < d.length; e++)q.push(Math.ceil(d[e] ? d[e].createLabelsAndCalculateWidth() : 0)), W += q[e], N += d[e] ? d[e].margin : 0; else q.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() : 0));
                J.push(q);
                if (b && 0 < b.length)for (e = 0; e < b.length; e++)b[e].lineCoordinates = {}, h = Math.round(g.x1 + Y + f), k = Math.round(g.x2 - W - N > m.width - 10 ? m.width - 10 : g.x2 - W - N), b[e].labelAutoFit && !x(u) && (0 < !a.length &&
                ...
                if (c && 0 < c.length)for (e = 0; e < c.length; e++)c[e].lineCoordinates = {}, h = Math.round(g.x1 + Y + f), k = Math.round(g.x2 - W -
                ...
                if (b && 0 < b.length)for (z = [], e = O = 0; e < b.length; e++)z.push(Math.ceil(b[e] ?
                    b[e].createLabelsAndCalculateHeight() : 0)), O += z[e] + b[e].margin, B += b[e].margin; else z.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() : 0));
                s.push(z);
                if (c && 0 < c.length)for (A = [], e = V = 0; e < c.length; e++)A.push(Math.ceil(c[e] ? c[e].createLabelsAndCalculateHeight() : 0)), V += A[e], S += c[e].margin; else A.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
                G.push(A);
                if (b && 0 < b.length)for (e = 0; e < b.length; e++)0 < b[e]._labels.length && (n = b[e]._labels[0], l = b[e]._labels[b[e]._labels.length - 1], u = n.textBlock.width *
                ...
                if (c && 0 < c.length)for (e = 0; e < c.length; e++)c[e] && 0 < c[e]._labels.length && (n = c[e]._labels[0], l = c[e]._labels[c[e]._labels.length - 1], v = n.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(n.textBlock.angle)) +
                ...
                if (m.panEnabled)for (e = 0; e < b.length; e++)z[e] = m.sessionVariables.axisY.height; else for (e = 0; e < b.length; e++)m.sessionVariables.axisY.height = z[e];
                if (b && 0 < b.length)for (e = b.length - 1; 0 <= e; e--)l = Math.round(g.y2), n = Math.round(g.y2 > b[e].chart.height - 10 ?
                ...
                if (c && 0 < c.length)for (e = c.length - 1; 0 <= e; e--)c[e] && (l = Math.round(g.y1), n = Math.round(g.y1 + (A[e] + c[e].margin + R)),
                ...
                if (a && 0 < a.length)for (e = 0; e < a.length; e++) {
                    ...
                    if (b && 0 < b.length)for (B = 0; B < b.length; B++)b[B] && b[B].labelAutoFit && (k = 0 > b[B].labelAngle ? Math.max(k, u) : 0 === b[B].labelAngle ? Math.max(k, u / 2) : k, h = 0 > b[B].labelAngle || 0 === b[B].labelAngle ? k - Y : h);
                    if (c && 0 < c.length)for (B = 0; B < c.length; B++)c[B] && c[B].labelAutoFit &&
                    (k = c[B].lineCoordinates.x1, h = k - Y);
                    a[e].lineCoordinates = {x1: k - M, y1: l, x2: k - M, y2: n, height: Math.abs(n - l)};
                    a[e].bounds = {x1: k - (D[e] + M), y1: l, x2: k, y2: n, width: k - h, height: n - l};
                ...
                if (d && 0 < d.length)for (e = 0; e < d.length; e++) {
                    ...
                    n = b && 0 < b.length ? Math.round(b[0] ? b[0].lineCoordinates.y1 : g.y2 - O > m.height - Math.max(B, 10) ? m.height - Math.max(B, 10) : g.y2 - O) : g.y2 > m.height - Math.max(B, 10) ? m.height - Math.max(B, 10) : g.y2;
                    if (b && 0 < b.length)for (B = 0; B < b.length; B++)b[B] && b[B].labelAutoFit && (k = 0 > b[e].labelAngle ? Math.max(k, u) : 0 === b[e].labelAngle ? Math.max(k, u / 2) : k, h =
                        0 > b[B].labelAngle || 0 === b[B].labelAngle ? k - W : h);
                    if (c && 0 < c.length)for (B = 0; B < c.length; B++)c[B] && c[B].labelAutoFit && (k = c[B].lineCoordinates.x2, h = k - W);
                    d[e].lineCoordinates = {x1: k + P, y1: l, x2: k + P, y2: n, height: Math.abs(n - l)};
                    d[e].bounds = {x1: h, y1: l, x2: k + q[e] + P, y2: n, width: k - h, height: n - l};
                ...
                if (c && 0 < c.length)for (e = 0; e < c.length; e++)c[e].calculateValueToPixelConversionParameters();
                if (0 < r) {
                    if (a && 0 < a.length)for (e = 0; e < a.length; e++)E = H[r - 1][e] === H[r][e] ? !0 : !1; else E = !0;
                    if (d && 0 < d.length)for (e = 0; e < d.length; e++)F = J[r - 1][e] === J[r][e] ? !0 : !1; else F = !0;
                    if (b && 0 < b.length)for (e = 0; e < b.length; e++)K = s[r - 1][e] === s[r][e] ? !0 : !1; else K = !0;
                    if (c && 0 < c.length)for (e = 0; e < c.length; e++)I = G[r - 1][e] === G[r][e] ? !0 : !1; else I = !0
                }
                if (E && F &&
                    K && I)break;
                r++
    ...
    A.prototype.renderLabelsTicksAndTitle = function () {
        ...
        if ("undefined" === typeof this.options.interval) {
            ...
            if ("left" === this._position || "right" === this._position)if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                for (var d =
                    [], n, h = this.viewportMaximum, l = this.lineCoordinates.height / Math.log(this.range), k = this._labels.length - 1; 0 <= k; k--) {
                    m = this._labels[k];
                    if (m.position < this.viewportMinimum)break;
    ...
    A.prototype.renderStripLinesOfThicknessType = function (a) {
        if (this.stripLines && 0 < this.stripLines.length && a) {
            ...
            for (c = 0; c < this._stripLineLabels.length; c++)if (n = this.stripLines[c], b = this._stripLineLabels[c], !(b.position < this.viewportMinimum || b.position > this.viewportMaximum || isNaN(this.range))) {
                a = this.getPixelCoordinatesOnAxis(b.position);
                if ("outside" === b.stripLine.labelPlacement)if (n && (this.ctx.strokeStyle = n.color, "pixel" ===
            ...
            if (h)for (h = !1, c = 0; c < k.length; c++)b = k[c], b.stripLine.showOnTop ? h || (h = !0, this.chart.addEventListener("dataAnimationIterationEnd", function () {
    ...
    A.prototype.renderGrid = function () {
        if (this.gridThickness && 0 < this.gridThickness) {
            ...
            if ("bottom" === this._position || "top" === this._position)for (c = 0; c < this._labels.length; c++)this._labels[c].position < this.viewportMinimum || this._labels[c].position > this.viewportMaximum || (a.beginPath(), d = this.getPixelCoordinatesOnAxis(this._labels[c].position), d = 1 === a.lineWidth % 2 ? (d.x << 0) + 0.5 : d.x << 0, a.moveTo(d, b.y1 << 0), a.lineTo(d,
    ...
    A.prototype.convertPixelToValue = function (a) {
        ...
        var d = 0, d = 0, d = "number" === typeof a ? a : "left" === this._position || "right" === this._position ? a.y : a.x;
    ...
    A.prototype.calculateAxisParameters = function () {
        if (this.logarithmic)this.calculateLogarithamicAxisParameters(); else {
            ...
            var a = Math.max(c, Math.floor(this.maxWidth / a)), f, g, h, c = 0;
    ...
    A.prototype.calculateLogarithamicAxisParameters = function () {
        ...
        var a = "axisX" === this.type ? 500 > this.maxWidth ? 7 : Math.max(7, Math.floor(this.maxWidth /
            100)) : Math.max(Math.floor(this.maxWidth / 50), 3), c, f, g, h;
        h = 1;
        if (null === this.viewportMinimum || isNaN(this.viewportMinimum))this.viewportMinimum = this.minimum;
        if (null === this.viewportMaximum || isNaN(this.viewportMaximum))this.viewportMaximum = this.maximum;
    ...
    A.prototype.getLabelStartPoint = function () {
        var a = H[this.intervalType + "Duration"] * this.interval, a = new Date(Math.floor(this.viewportMinimum / a) * a);
            ...
            if (this.shared &&
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if (this.chart.axisX2)for (l = 0; l < this.chart.axisX2.length; l++) {
                        h =
                            this.chart.axisX2[l].convertPixelToValue({y: d});
                        k = null;
                    ...
                    f = [];
                    if (this.chart.axisX)for (l = 0; l < this.chart.axisX.length; l++)for (h = this.chart.axisX[l].convertPixelToValue({x: a}), k = null, c = 0; c < this.chart.axisX[l].dataSeries.length; c++)(k = this.chart.axisX[l].dataSeries[c].getDataPointAtX(h,
                        b)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[l].dataSeries[c], null !== k.dataPoint.y && f.push(k));
                    if (this.chart.axisX2)for (l = 0; l < this.chart.axisX2.length; l++)for (h = this.chart.axisX2[l].convertPixelToValue({x: a}), k = null, c = 0; c < this.chart.axisX2[l].dataSeries.length; c++)(k = this.chart.axisX2[l].dataSeries[c].getDataPointAtX(h, b)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[l].dataSeries[c], null !== k.dataPoint.y && f.push(k))
                }
                ...
                if (k = this.chart.getDataPointAtXY(a, d, b))this.currentDataPointIndex = k.dataPointIndex, this.currentSeriesIndex = k.dataSeries.index; else if (v)if (k = Ma(a, d, this.chart._eventManager.ghostCtx), 0 < k && "undefined" !== typeof this.chart._eventManager.objectMap[k]) {
                ...
                if (0 <= this.currentSeriesIndex) {
                    ...
                    "stackedColumn" === f.type || "stackedBar" === f.type || k.dataPoint.y >= k.dataSeries.axisY.viewportMinimum && k.dataPoint.y <= k.dataSeries.axisY.viewportMaximum) && g.push(k); else g.push(k)
                }
            }
    ...
    z.prototype.getPercentAndTotal = function (a, d) {
        ...
        if (0 <= a.type.indexOf("stacked"))c =
            0, b = d.x.getTime ? d.x.getTime() : d.x, b in a.plotUnit.yTotals && (c = a.plotUnit.yTotals[b], f = isNaN(d.y) ? 0 : 0 === c ? 0 : 100 * (d.y / c)); else if ("pie" === a.type || "doughnut" === a.type) {
    ...
    z.prototype.replaceKeywordsWithValue = function (a, d, b, c, f) {
        ...
        return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function (a) {
            ...
            if (d.hasOwnProperty(a))h = d; else if (b.hasOwnProperty(a))h =
                b; else return "";
            h = h[a];
            null !== e && (h = h[e]);
            if ("x" === a)if ("dateTime" === g.plotInfo.axisXValueType || "dateTime" === b.xValueType || d.x && d.x.getTime) {
                ...
                b.xValueFormatString ? b.xValueFormatString : b.xValueFormatString = "#,##0.########", g._cultureInfo); else return "y" === a ? fa(h, d.yValueFormatString ? d.yValueFormatString : b.yValueFormatString ? b.yValueFormatString : b.yValueFormatString = "#,##0.########", g._cultureInfo) : "z" === a ? fa(h, d.zValueFormatString ? d.zValueFormatString : b.zValueFormatString ? b.zValueFormatString : b.zValueFormatString = "#,##0.########", g._cultureInfo) : h
        })
    };
        ...
        if ("mousemove" === a.type || "click" === a.type) {
            ...
            if ((c = this.chart.getObjectAtXY(b.x, b.y, !1)) && "undefined" !== typeof this.objectMap[c])if (c = this.objectMap[c], "dataPoint" === c.objectType) {
                var f = this.chart.data[c.dataSeriesIndex],
                    g = f.dataPoints[c.dataPointIndex], h = c.dataPointIndex;
                c.eventParameter = {
                    x: b.x,
                    y: b.y,
                    dataPoint: g,
                ...
                c.eventContext = {
                    context: f, userContext: f.options, mouseover: "mouseover",
    ...
    Ea.prototype.animate = function (a, d, b, c, f) {
        ...
        for (a = []; 0 < this.animations.length;)if (d = this.animations.shift(), b = (new Date).getTime(), c = 0, d.startTime <= b && (c = f(Math.min(b - d.startTime, d.duration), 0, 1, d.duration), c = Math.min(c, 1), isNaN(c) || !isFinite(c)) &&
    ...
    var E = {
        ...
        Chart: z, addColorSet: function (a, d) {
            ja[a] = d
